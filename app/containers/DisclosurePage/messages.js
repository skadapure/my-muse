...
export default defineMessages({
  ...
  collect: {
    id: 'boilerplate.containers.DisclosurePage.how',
    defaultMessage: 'Non Eggetarian may collect and use Users personal information for improving our Site, we may use feedback you provide to improve our products and services, and to send periodic emails we may use the email address to respond to their inquiries, questions, and/or other requests.',
  },
  collectHeader: {
    id: 'boilerplate.containers.DisclosurePage.collectHeader',
    defaultMessage: 'How we use collected information',
  },
  protect: {
