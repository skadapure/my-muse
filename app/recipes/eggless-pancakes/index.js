...
export default ({
  ...
  ingredients: ['1 Cup All Purpose Flour', '1 Tablespoon Sugar', '1 Teaspoon Baking Powder', '1/4 Teaspoon Baking Soda', 'A Pinch of Salt', '1/2 Cup Milk ', '1/2 Cup Water', '2 Tablespoon Vegetable Oil/ Butter', '1 Teaspoon Vanilla Extract'],
  steps: ['Stir together the dry ingredients', 'Measure 1/2 cup of milk. To that add vegetable oil, water and vanilla extract.', 'Stir the wet ingredients and add dry ingredients to the mixture. Do not over-mix. Lumps are perfectly fine. Set aside for a couple of minutes.', 'Heat a griddle at medium-high heat.', 'When the pan is hot enough, pour a ladleful of batter on the pan for each pancake. Cook until bubbles appear on the face of the pancake.', 'Carefully flip the pancake and cook until its golden brown.'],
  taste: 'Light, soft and fluffy! You have to add some maplesyrup or something to sweeten it because its not sweet by itself. But I guess that’s how pancakes are supposed to be.',
  notes: '',
});
